-- Function: raw_material_cons_rate_dates_process()

-- DROP FUNCTION raw_material_cons_rate_dates_process();

CREATE OR REPLACE FUNCTION raw_material_cons_rate_dates_process()
  RETURNS trigger AS
$BODY$
BEGIN	
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION raw_material_cons_rate_dates_process()
  OWNER TO beton;
