-- Function: get_working_vehicles_count_main(date)

-- DROP FUNCTION get_working_vehicles_count_main(date);

CREATE OR REPLACE FUNCTION get_working_vehicles_count_main(start_shift_date date)
  RETURNS bigint AS
$BODY$
	SELECT COUNT(*)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION get_working_vehicles_count_main(date)
  OWNER TO beton;
