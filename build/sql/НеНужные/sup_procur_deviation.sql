--SELECT * FROM sup_procur_deviation('2014-11-01')
-- Function: sup_procur_deviation(check_date date)

--DROP FUNCTION sup_procur_deviation(check_date date);

CREATE OR REPLACE FUNCTION sup_procur_deviation(
	check_date date
	)
  RETURNS TABLE(	
	supplier_id int,
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION sup_procur_deviation(check_date date)
  OWNER TO beton;
