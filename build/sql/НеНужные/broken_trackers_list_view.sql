-- View: broken_trackers_list_view

-- DROP VIEW broken_trackers_list_view;

CREATE OR REPLACE VIEW broken_trackers_list_view AS 
 SELECT sub.plate,
    sub.tracker_id,
    sub.last_data
...
ALTER TABLE broken_trackers_list_view
  OWNER TO beton;
