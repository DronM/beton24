-- Function: lab_item_report(timestamp without time zone, timestamp without time zone, integer, integer)

DROP FUNCTION lab_item_report(timestamp without time zone, timestamp without time zone, integer, integer);

CREATE OR REPLACE FUNCTION lab_item_report(
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION lab_item_report(timestamp without time zone, timestamp without time zone, integer, integer)
  OWNER TO beton;
