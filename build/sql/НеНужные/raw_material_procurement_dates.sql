-- Function: raw_material_procurement_dates(timestamp,timestamp)

--DROP FUNCTION raw_material_procurement_dates(timestamp,timestamp);

CREATE OR REPLACE FUNCTION raw_material_procurement_dates(IN in_date_time_from timestamp, IN in_date_time_to timestamp)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION raw_material_procurement_dates(timestamp,timestamp) OWNER TO beton;
