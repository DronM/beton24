-- Function: ra_material_consumption_doc_materials(timestamp,timestamp)

--DROP FUNCTION ra_material_consumption_doc_materials(timestamp,timestamp);

CREATE OR REPLACE FUNCTION ra_material_consumption_doc_materials(IN in_date_time_from timestamp, IN in_date_time_to timestamp)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION ra_material_consumption_doc_materials(timestamp,timestamp) OWNER TO beton;
