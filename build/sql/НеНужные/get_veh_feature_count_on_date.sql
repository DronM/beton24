-- Function: get_veh_feature_count_on_date(date)

-- DROP FUNCTION get_veh_feature_count_on_date(date);

CREATE OR REPLACE FUNCTION get_veh_feature_count_on_date(IN in_date date)
...
$BODY$
  ...
  COST 100
  ROWS 1000;
ALTER FUNCTION get_veh_feature_count_on_date(date)
  OWNER TO beton;
