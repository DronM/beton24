...
CREATE OR REPLACE FUNCTION raw_material_cons_rates(IN in_concrete_type_id integer, IN in_date_time timestampTZ)
  RETURNS TABLE(concrete_type_id integer, material_id integer, rate numeric) AS
$BODY$
	SELECT
