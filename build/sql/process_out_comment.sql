-- Function: process_out_comment()

-- DROP FUNCTION process_out_comment();

CREATE OR REPLACE FUNCTION process_out_comment()
  RETURNS trigger AS
$BODY$
DECLARE
	init_state vehicle_states;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION process_out_comment()
  OWNER TO beton;
