...
class OrderDialog_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("order_dialog_view");
		...
		$f_order_temp_comment_descr=new FieldSQlString($this->getDbLink(),$this->getDbName(),$this->getTableName()
		,"order_temp_comment_descr"
		,array(
		
			'id'=>"order_temp_comment_descr"
				
		
		));
		$this->addField($f_order_temp_comment_descr);
