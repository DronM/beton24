...
class OrderTempList_Model extends ModelSQL{
	...
	public function __construct($dbLink){
		...
		$this->setTableName("orders_temp_list");
		...
		$f_order_temp_commen_descr=new FieldSQlString($this->getDbLink(),$this->getDbName(),$this->getTableName()
		,"order_temp_commen_descr"
		,array(
		
			'id'=>"order_temp_commen_descr"
				
		
		));
		$this->addField($f_order_temp_commen_descr);
